    ...
    <div class="singles">
        <div class="singles__single">
            ...
            <div class="single__excerpt">
                ...
                <p>
                    <span v-if="this.categoryId == '1'"><b>Category:</b> Blog</span>
                    <span v-if="this.categoryId == '8'"><b>Category:</b> Services</span>
                    <span v-if="this.categoryId == '9'"><b>Category:</b> Case Studies</span>
                    <span v-if="this.categoryId == '14'"><b>Category:</b> About</span>
                    <span v-else></span>
                </p>
...
.singles{background: #fff;color: #111; display: block; float: left; padding: 6em 0 1em 0; width: 100%;min-height: 100vh;}
