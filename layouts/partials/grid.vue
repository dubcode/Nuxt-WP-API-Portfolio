...
.grid__tile h3{text-align: center;transform: translateY(1em);  margin: 0 0 0.25em 0; color: #fff; display: inline-block; font-size: 2em; text-transform: uppercase; letter-spacing: 4px; line-height: 1em; font-family: 'Playfair Display', serif; font-weight: 400;transition: all ease 0.5s;}
.grid__tile .hr{margin: 0.25em 0;transform: translateY(0); transition: all ease 0.5s;}
.grid__tile p{color: #fff; font-weight: 400; font-size: 1.2em; line-height: 1.4em; margin: 0; opacity: 0;padding:0; transform: translateY(-50px); padding: 2em 0; text-align: center;transition: all ease 0.5s;}
...
.grid__tile:hover h3,
.grid__tile:hover p{opacity: 1; transform: translateY(0); transition: all ease 0.5s;}
